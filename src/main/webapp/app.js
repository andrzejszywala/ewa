...
var appModule = angular.module(
		...
		[ 'ngRoute', "ngAnimate", 'ngResource', 'ui.bootstrap', 'ui.utils', 'ui.validate', 'ui.grid', 'ui.grid.resizeColumns', 'ui.grid.pinning',
				'ui.grid.selection', 'ui.calendar', 'ngWebSocket', 'ng-fusioncharts', 'openkp.kontekstAplikacji', 'openkp.pracownicy', 'openkp.pracownikEdycja', 'openkp.pracownikNowy',
				'openkp.absencje', 'openkp.profil', 'openkp.dashboard', 'openkp.import', 'openkp.positions', 'openkp.summary' ]).config([ '$routeProvider', function($routeProvider) {
